...
Note: For the purposes of this post, I have trained a simple variational autoencoder on MNIST dataset .The code for all the results can be found on my GitHub account [VAE]({{ site.url }}{% link /Notebooks/VAE %}).
